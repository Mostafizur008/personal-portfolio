                                                    ...
                                                    <div class="row g-4">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input type="project" name="project"  class="form-control" placeholder="Project Name">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <textarea type="description" name="description" class="form-control">Hello, World!</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
